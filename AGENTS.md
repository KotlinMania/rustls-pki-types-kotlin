...
This file is the quick-reference operating contract for rustls-pki-types-kotlin. The longer
...
rustls-pki-types-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rustls-pki-types`](https://crates.io/crates/rustls-pki-types). Upstream Rust is the behavioral oracle while the
