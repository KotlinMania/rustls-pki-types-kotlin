...
kotlin {
    ...
    val xcf = XCFramework("RustlsPkiTypes")

    macosArm64 {
        binaries.framework { baseName = "RustlsPkiTypes"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RustlsPkiTypes"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RustlsPkiTypes"
        flattenPackage = "io.github.kotlinmania.rustlspkitypes"
    }

    android {
        namespace = "io.github.kotlinmania.rustlspkitypes"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rustls-pki-types-kotlin", version.toString())

    pom {
        name.set("rustls-pki-types-kotlin")
        description.set("Kotlin Multiplatform port of rustls/pki-types - Shared types for the rustls PKI ecosystem")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rustls-pki-types-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rustls-pki-types-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rustls-pki-types-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rustls-pki-types-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRustlsPkiTypesXCFramework",
    "assembleRustlsPkiTypesDebugXCFramework",
    "assembleRustlsPkiTypesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseIosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugMacosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseMacosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugTvosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseTvosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugWatchosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseWatchosFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRustlsPkiTypesXCFramework",
